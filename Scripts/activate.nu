...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Programering\Django\HajiHoseini\Django_Project\bookstore'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Programering\Django\HajiHoseini\Django_Project\bookstore\Scripts\deactivate.nu'
